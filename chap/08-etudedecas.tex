...
% TODO rajouts propres à moi ou pas?
% TODO[E] dire que cela est inclus dans ton travail
...
%TODO[S] je ne trouve pas que le passage à l'asm soit parlant. rester au niveau
%de C et montrer l'enchaînement des appels en disant lesquels sont en ring 0 et
%ceux en ring 3 serait plus parlant. on ne voit pas bien les pointeurs ut et
%noyau.
...
% TODO[S] un peu rude à comprendre
...
% TODO[E] pourquoi des sauts de ligne? est-ce le code d'origine?
% TODO il y a la place maintenant
...
=\textgreater{} */}. En théorie, si un utilisateur passe un pointeur vers une
adresse du noyau à la fonction \texttt{ptrace}, il pourra lire des données du
noyau. L'appel \texttt{ptrace (PTRACE\_PEEKDATA, p, addr)} permet ainsi non
seulement de lire les variables du processus \texttt{p} si \texttt{addr} est une
adresse dans l'espace utilisateur (ce qui est le comportement attendu), mais
aussi de lire dans l'espace noyau si \texttt{addr} y pointe (ce qui est un bug
de sécurité).

% TODO[E] marqueur: fais pareil sur le 1er ex
...
% TODO[E] on a le droit à quoi en annotant?
...
% TODO[S] il faut vraiment en parler?

% TODO[E] c'est possible de le changer rapidement?
...
% TODO[S] oui mais bcp était déjà fait non?
...
% TODO[S] bugs: d'autres que ceux décrits?
% TODO[S] fin: aucun rapport avec l'annotation automatique non?
% TODO[S] oui mais il faut réécrire le code pour supprimer les constructions non
% typables
