\epigraph{ Those who don't understand UNIX are condemned to reinvent it, poorly.}
         {--- \textup{Henry Spencer}}
...
ensemble de tables de pages et une valeur de \crtrois{} associée. Au moment de
changer le processus en cours, l'ordonnanceur charge donc le \crtrois{} du
nouveau processus.
...
matériel (c'était le but!). Pour qu'ils puissent interagir avec le système
(afficher une sortie, écrire sur le disque…) le mécanisme des appels système est
