...
\caption{Code du noyau minimisé et annoté}
\label{fig:ex-drm}
\end{figure}

% TODO et le code correct?

% TODO c'est juste le champ value qui est user?
...
(incluant une erreur de programmation) ne peut pas être typée.

% TODO et la version correcte?
