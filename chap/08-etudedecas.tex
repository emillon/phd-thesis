...
Dans d'anciennes versions de Linux\footnote{jusque 2.6.28 --- ce bug a été
corrigé dans le \emph{commit} \texttt{7786ce} en remplaçant l'appel à
\texttt{memcpy} par un appel à \texttt{copy\_from\_user\_page}}, cette fonction
appelle \texttt{memcpy} au lieu de \texttt{copy\_from\_user} pour lire dans la
mémoire du processus. En théorie, si un utilisateur passe un pointeur noyau à la
...
% TODO mets en valeur la partie du code qui pose problème
% TODO la figure est-elle citée?
...
% TODO attention tu sautes 2 pages pour la suite du texte
...
% TODO quel est le rapport (position)
