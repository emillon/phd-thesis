...
% TODO[E] tu pourrais mettre les numéros de ligne et infiquer les lignes dans le
% texte pour epliquer le clash
...
celle-ci, l'inférence se fait sans erreur. La partie pertinente est:

% TODO[E] est('ce que tu donne la syntaxe de ces constructions (=> citer)
...
correspondantes aux appels sensibles sont:
...
% TODO[S] lire autant de npk n'est pas facile, peut etre en 2 couleurs
