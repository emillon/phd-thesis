...
\begin{theorem}[ de Rice\cite{rice} ]
...
% Flèches "?"
\draw [<->] (2cm,2.6cm) -- node [left]  {?} ++(0,9mm);
\draw [<->] (2.8cm,1cm) -- node [above] {?} ++(17mm,0);
\draw [<->] (5mm,1cm)   -- node [above] {?} ++(-4mm,0);
\draw [<->] (2cm,5mm)   -- node [left]  {?} ++(0,-4mm);
\end{tikzpicture}%}}}
% 4
\begin{tikzpicture}[scale=0.7]%{{{
\clip  (-1,-1) rectangle (6,5);
...
% Flèches "OK"
\draw [<->] (2cm,3.1cm) -- node [left]  {\tiny OK !} ++(0,5mm);
\draw [<->] (3.1cm,1cm) -- node [above] {\tiny OK !} ++(15mm,0);
\draw [<->] (3.5mm,1cm)   -- node [above] {\tiny OK !} ++(-3mm,0);
\draw [<->] (2cm,3.5mm)   -- node [left]  {\tiny OK !} ++(0,-3mm);
\end{tikzpicture}%}}}
% 6
\begin{tikzpicture}[scale=0.7]%{{{
\clip  (-1,-1) rectangle (6,5);
