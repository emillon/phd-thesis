...
Version par soustractions successives:
...
\def\exinnerif{\iIf{a > b}{a ← a - b}{b ← b - a}\xspace}

\begin{mathpar}
  f(a, b) \{
    \iIf{a = 0}{\iReturn{b}}{\iPass};
    \iWhile{b ≠ 0}{
      \exinnerif
    }
  \}
...
\[
  (m[a↦1071][b↦462], \iIf{a = 0}{\iReturn{b}}{\iPass}; \iWhile{b ≠ 0}{\exinnerif}) → ?
\]
...
En appliquant (Seq) on en déduit :

\begin{align*}
  s_0 → (m_0, \iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_0, \iIf{b ≠ 0}{\exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }}{\iPass}) \\
      → (m_0, \exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_0, a ← a - b ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_1, \iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_1, \iIf{b ≠ 0}{\exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }}{\iPass}) \\
      → (m_1, \exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_1, a ← a - b ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_2, \iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_2, \iIf{b ≠ 0}{\exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }}{\iPass}) \\
      → (m_2, \exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_2, b ← b - a ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_3, \iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_3, \iIf{b ≠ 0}{\exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }}{\iPass}) \\
      → (m_3, \exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_3, b ← b - a ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_4, \iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_4, \iIf{b ≠ 0}{\exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }}{\iPass}) \\
      → (m_4, \exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_4, b ← b - a ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_5, \iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_6, \iIf{b ≠ 0}{\exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }}{\iPass}) \\
      → (m_6, \exinnerif ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      → (m_6, a ← a - b ;\iWhile{b ≠ 0}{ \exinnerif }) \\
      DONE
\end{align*}

\begin{align*}
  m_1 = m_0[a↦609] = m[a↦609][b↦462] \\
  m_2 = m_1[a↦147] = m[a↦147][b↦462] \\
  m_3 = m_2[b↦315] = m[a↦147][b↦315] \\
  m_4 = m_3[b↦168] = m[a↦147][b↦168] \\
  m_4 = m_3[b↦21]  = m[a↦147][b↦21]  \\
  OK
\end{align*}
