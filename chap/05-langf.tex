...
La sémantique apérationnelle consiste en la définition d'une relation de
...
Alors
$T = \mkLens{\mathrm{get}_T}{\mathrm{put}_T} ∈ \textsc{Lens}_{L(E), E}$
et
$Q = \mkLens{\mathrm{get}_Q}{\mathrm{put}_Q} ∈ \textsc{Lens}_{L(E), L(E)}$.
