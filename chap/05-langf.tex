...
L'ensemble des adresses \sAddr est défini comme suit :
...
Les composantes d'un état mémoire sont :
...
On commence par définir une opération auxiliaire de plusieurs expressions :
...
\[
  m_{0}(P) = ([], (x_1, …, x_p), \{x_1 ↦ \widehat(0), …, x_p ↦ \widehat(0)\}))
\]
