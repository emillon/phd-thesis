...
\begin{definition}[Accès par adresse]
  ...
  \begin{align*}
    m [x]_m          = & g[x]_l        & \textrm{Lecture d'une globale} \\
    m [(n, x)]_m     = & l_n[x]_l      & \textrm{Lecture d'une locale} \\
    m [x ← v]_m      = & (s, g[x←v]_l) & \textrm{Écriture d'une globale} \\
    m [(n, x) ← v]_m = & (s', g)       & \textrm{Écriture d'une locale} \\
