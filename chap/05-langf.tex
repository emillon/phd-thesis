...
\begin{figure}
  ...
  \gramlr{Fonctions}{
    \begin{align*}
      f \gramisa & (i, (x_1, …, x_n)) & \textrm{Corps, arguments}
    \end{align*}
  }
  ...
  \gramlr{Programme}{
    \begin{align*}
      P \gramisa & ((f_1, …, f_n),
        ((x_1, e_1), …, (x_p, e_p))) & \textrm{Fonctions, globales}
    \end{align*}
  }
...
\begin{align*}
  \sVal = & \sInt \cup \sFloat \sAddr \\
  \sInt = & ℤ/2^{32} ℤ - 2^{31} \\
  \sAddr = & \sId \cup (ℕ × \sId)
\end{align*}

\sFloat correspond à l'ensemble des flottants IEEE 754. Ici, \sInt est choisi
pour représenter les nombres entiers de $-2^{31}$ à $2^{31}-1$, mais ce choix
est arbitraire : de la même manière, on aurait pu choisir des nombres à 64 bits
ou même de précision arbitraire.
