...
\begin{figure}
  ...
  \gramlr{État mémoire}{
    \begin{align*}
      m \gramisa & (s, \{ x_1 ; … ; x_n \}, \{a_1 ↦ v_1; … ; a_p ↦ v_p\}) & \textrm{Pile, globales, valeurs}
    \end{align*}
  }
...
\begin{definition}[Manipulations des états mémoire]
  ...
  On note $(a, v) ∈ m$ si blabla.

  Par extension, $(x, v) ∈ m$ si $(a, v) ∈ m$ avec $a = \textrm{VarLookup}(x, m)$.

  On note $m[a ↦ v]$ le blabla.

  On étend de même cette notation pour $m[x ↦ v]$.
\end{definition}
