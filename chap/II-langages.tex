...
langage C. Le chapitre~\ref{cha:lang} décrit sa syntaxe, ainsi que sa sémantique
d'exécution. À ce point, de nombreux programmes acceptés peuvent provoquer des
erreurs à l'exécution.

% TODO[S] le langage C ou une sous classe ?
...
n'empêche pas la présence d'erreurs de sécurité, qui sont évitées par l'ajout de
règles de typage supplémentaires.

%TODO[S] il reste => comment on fait alors? combinaison avec analyse dyn?
}
