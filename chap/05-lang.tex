...
L'état de l'interpréteur est constitué d'une continuation $k$ qui capture le flot de
contrôle, et d'un état mémoire $σ$ qui capture l'état des données.
...
$k_0 ((\vec{f},\vec{v},b)) = \kSeq{b}{\kPass}$
