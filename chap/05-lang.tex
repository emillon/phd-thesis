...
Pour une instruction \npkReturn{e}, on évalue l'expression en une valeur $v$ et on remplace la
continuation courante par $\kRet{v}$.
...
construit une continuation $\kCall{f}{\vec{v}}{a}$, qui remplace la continuation
courante.
