...
résultat, et sinon il lève une exception. Il arrive parfois que l'opération soit
possible, mais nécessite des conversions (cas \texttt{a+c}).
...
En lisant le code source d'un tel programme, on peut se rendre compte qu'il y
aura une erreur de type dynamique à l'exécution. Formaliser cette analyse
statique revient à établir un système de types statique.
