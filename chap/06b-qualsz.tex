...
Le langage C ne fournit pas directement de type \enquote{chaîne de caractères}.
C'est au programmeur de les gérer via des pointeurs sur caractère (\texttt{char
*}).
...
par 0 ont un nom qui commence par \texttt{sz}, comme \enquote{\texttt{szTitle}}.
C'est pourquoi nous appellerons ce qualificateur de type \texttt{sz}.
