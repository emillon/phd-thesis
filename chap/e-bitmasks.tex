...
On veut que les opérations bit à bit puissent s'appliquer aux bitmasks. On
ajoute donc par exemple cette règle pour le ``ou'':
...
inférer de type pour la fonction suivante:
...
\paragraph{Polymorphisme limité}
...
\begin{itemize}
    ...
    \item si on autorise le polymorphisme non limité (en donnant par exemple à
