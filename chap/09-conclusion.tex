...
%TODO[E] et le contexte industriel?

\section{Différences avec C}

% TODO[S] spk: le nommer dans la partie précédente
...
% TODO[S] tu n'en parles pas dans la descr de ton analyseur
...
% TODO[S] c'est vrai ça?
% TODO[S] onpourrait imaginer de l'asm inline
...
% TODO[S] mais à l'intérieur c'est pas typé
...
accéder aux zones mémoires libérées, ni libérer deux fois la même zone mémoire.
\added{double free} Il est aussi possible d'obtenir cette garantie avec une
analyse préalable. Par exemple, il est possible ici encore d'utiliser une
...
% TODO[S] une conclusion de conclusion?
...
% TODO[E] peut être revenir sur ce que tu peux détecter et comment le faire
% + le cadre industriel
