...
% TODO[E] + expérimentation

% TODO[S] un outil

\section{Limitations et travaux futurs} % TODO[S] renommer
...
% TODO[S] sauf dans les champs de struct?
...
En fait, les casts entre types entiers ne posent pas de problème. Ceux entre
% TODO[S] pourquoi
...
La conversion dans le sens inverse, d'entier vers pointeur, est
...
% TODO[S] ok mais pas dans npk, les valeurs conservent leur type

% (e) le pb est qu'on a besoin du programme pour typer la mémoire, à l'exécution
% il n'y a que des octets
