...
plus complexe \footnote{D'ailleurs, en vertu du théorème de Rice, il n'est pas
calculable.}.
...
\item
  problèmes liés à la compilation (instrumentation de Makefile)
\item
  programmes non autosuffisants (headers, fonctions de bibliothèque)
\item
  sémantique de l'OS (accès aux fichiers)
\item
  threads / multiprocessus
\end{itemize}
