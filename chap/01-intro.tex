...
exemple, l'évaluation des arguments d'une fonction est faite de
...
\newspeak (ce qui permet grâce à un traducteur de traiter des programmes écrits
en C) et est redistribuée avec celui-ci.
