...
se retrouver face à grands impacts économiques, voire risquer des vies humaines.
On comprend bien que les phases de vérification et de certification sont au cœur
...
% TODO[E] fonctionnel/structurel? et l'intégration?
...
% TODO[S] sur = ? ↑ + complexe et surtout pas calculable
% TODO[E] déf sound
...
% TODO[S] termes corrects, surs non définis. tu parles à la fois
% de domaines et de domaines abstraits
...
% TODO[S] caption faux: pas le cas en bas à gauche
\end{figure}
...
%TODO[S] ↑ redite avec le domaine des intervalles du para précédent
...
% TODO[S] ex sur l'éval des arfuments
...
% TODO[E] pourquoi pas open source?
...
% TODO[S] je ne suis pas convaincue
...
mentionnés dans la section~\ref{sec:lang-int}. Nous proposons d'étendre
...
% TODO [S] tu as déjà expliqué que ct mieux sur un IR!!
% TODO [S] pas clair
...
%TODO[S] pas clair. quel rappor entre npk et spk? lequel dev tu? ajouter un élt
%du contexte CIFRE?
...
indépendantes du système de types. La première consiste à bien typer les entiers
...
% TODO[S] deux extensions.. du langage impératif considéré?
