...
% TODO [E] volontairement ou involontairement ?
...
% TODO [E] dis un mot sur les analyses statiques de programmes qui permettent de
% détecter des erreurs avant l'exécution des programmes quitte à limiter la
% possibilité d'en écrire certains, et ensuite tu parles du typage statique qui
% vérifie...
...
% TODO [E] peut être dire qu'ils proviennent souvent d'une utilisation
% litigieuse de pointeurs
...
programmes peuvent être aussi être exécutés. Ce sont ceux-ci qui sont d'ailleurs
visibles pour l'utilisateur. % TODO rep: exécutés
...
% TODO [E] lien mode noyau et privilège superviseur
...
données utilisateur. D'après le tableau précédent, % TODO figure pê ?
...
% TODO [E] faire le lien avec le début de l'intro : source fréquente de bugs
...
% TODO [E] ajouter deux adresses : si :-)
...
% TODO [E] il y a deux types de polymorphisme :
% - code différent selon le type des arguments
% - même code quelque soit le type des arguments
...
% TODO tu peux en citer certains : CMinor, C--, Newspeak...
...
% TODO [E] il manque un lien entre la fin des langages d'analyse et la suite!!!
