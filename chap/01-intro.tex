...
% TODO que veut dire EADS ? pourquoi l'introduire ici?
% produits?
...
% TODO tu vas un peu vite dans le passage on typ es entiers puis on veut isoler
% des parties de l'OS: ajoute une phrase de lien
...
% TODO ne faut il pas dire un mot plus précis ici? à voir
...
% TODO pourquoi alors que la dernière phrase explicite?
...
% TODO sans parler de sous typage?
...
code lors de la compilation d'OCaml~\link{ocaml}, et disponible dans
...
% TODO il faut peut être indiquer la classe de problèmes traités et son
% expérimentation
