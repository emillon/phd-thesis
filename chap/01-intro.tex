...
Clight\cite{cfront} et Cminor\cite{cminorSL} qui est utilisé pour les passes de
middle-end.
...
% TODO couleurs N&B (reprendre couleurs lentilles) + noms dans texte
\begin{figure}
\centering
...
% TODO est-ce la sémantique qui est changée ? dans ton exemple il peut y avoir
% la perte du déterminisme mais c'est dans le modèle de calcul
...
% TODO d'autres constructions

\section{Notre solution}

% TODO n'est-ce pas un peu court?
...
% TODO inspiré ou bien construit au dessus ? quid des traducteurs?
