...
\todo{Réordonner ces définitions}
...
\begin{align*}
Γ  \gramisa & (Γ_f, Γ_v) & \textrm{Fonctions, variables}
\end{align*}

\begin{align*}
Γ_f  \gramisa & ε       & \textrm{Environnement vide}
\\   \gramor  & Γ_f,g:σ & \textrm{Ajout d'une fonction}
\end{align*}

\begin{align*}
Γ_v  \gramisa & ε       & \textrm{Environnement vide}
\\   \gramor  & Γ_v,x:τ & \textrm{Ajout d'une variable}
\end{align*}
}

Lorsque ce n'est pas ambigü, si $Γ=(Γ_f,Γ_v)$ on notera les extensions
d'environnement $Γ,f:σ$ pour $((Γ_f,f:σ), Γ_v)$ et $Γ,x:τ$ pour
$(Γ_f,(Γ_v,x:τ))$. De même, on notera $(f, σ) ∈ (Γ_f, Γ_v)$ si $(f, σ) ∈ (Γ_f)$,
ou $(x, τ) ∈ (Γ_f, Γ_v)$ si $(x, τ) ∈ (Γ_v)$.
