...
modélisant les variables présentes dans l'espace utilisateur. Celles-ci restent
accessibles, mais nécessitent d'utiliser un opérateur de déréférencement sûr qui
vérifie à l'exécution que l'invariant suivant est respecté :
...
Tout d'abord, on définit un nouveau type d'erreur $Ω_{taint}$, déclenché
...
On ajoute à \langname la notion de valeur provenant de l'espace utilisateur (cf.
