...
et $\phxx{\uGet}$ de copie sûre. $\uGet{p_k}{p_u}$ copie la valeur par pointée
par $p_u$ (qui se trouve en espace utilisateur) à l'emplacement mémoire pointé
par $p_k$ (en espace noyau). $\uPut{p_u}{p_k}$ réalise l'opération inverse, en
copiant la valeur par pointée par $p_k$ (en espace noyau) à l'emplacement
mémoire pointé par $p_u$ (en espace utilisateur).
