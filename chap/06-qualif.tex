...
une construction syntaxique $\eTaint{e}$ telle que, si $e$ s'évalue en
$\wphi{φ}$, $\eTaint{e}$ s'évalue en $\wphi{\vTainted{φ}$}. Cela demande 2
autres ajouts: un nouveau contexte d'évaluation $\eTaint{C}$ et une règle
d'évaluation. Enfin, on ajoute une nouvelle erreur $\serr{sec}$ à déclencher
...
% TODO[E] attention on tombe sur la figure
