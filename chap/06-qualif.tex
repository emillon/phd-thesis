Dans ce chapitre, nous présentons deux extensions du système de types décrit
...
Les différents types d'entier correspondent à du sous-typage. La méthode
...
L'alternative $!~(x \& y)$ a plus de sens: elle vaut $0$ si $x$ et $y$ ont un
bit en commun, $1$ sinon.
...
En revanche la seconde est bien typée (figure~\ref{fig:notxy-ok}).
