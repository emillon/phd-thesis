...
On vérifier enfin que la première n'est pas bien typée alors que la
seconde l'est. Dans les deux cas suivants on se place dans un environnement $Γ$
...
que les valeurs d'un certain type ne peuvent être crées que par un certain
nombre de sources. Par exemple ici les bitmasks ne proviennent que de
