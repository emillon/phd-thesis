...
%TODO[PJ]: quid en cas de redéfinition?
...
%TODO[PJ]: quid si x n'est pas défini?
...
%TODO[PJ] dire que c'est global et ne plus le noter
...
exactement un «$C$». Chaque contexte est donc constitué d'exactement une
...
\item D'après la règle~\textsc{Exp-Binop}, %TODO[PJ] ref règle
...
$\widehat{+}$ est l'addition classique entre entiers. Comme précisé dans la
section~\ref{sec:sem-ops}, la division par zéro via $/$, $\%$ ou $\floatop{/}$
provoque l'erreur $\serr{div}$.

%TODO[PJ]: noter que la taille finie des ints n'est pas prise en compte
...
%TODO[PJ] et si n-i < 0 ou dépasse?
...
% TODO[PJ] le cleanvarV comment ça marche avec les decl de structures
% recursives?
...
sont rappelées dans l'annexe~\ref{anx:eval}.
%TODO[PJ] B1 à B7
