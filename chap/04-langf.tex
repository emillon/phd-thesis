...
donc $p_2 = f=\eFun{q}{*q←1;\iReturn{\eUnit}}$. De plus, un prétraitement va
...
\textsc{ET-Var}. Celle-ci va étendre l'ensemble (vide) des globales mais demande
d'évaluer l'expression $0$. D'après \textsc{Exp-Cst},
$\mm{m_0}{0}{m_0}{\widehat{0}}$.

Donc $\ph{m_0}{x = 0}{m_1}$ en posant
