...
\begin{figure}%{{{
  ...
  \gramlr{Erreur}{
    \begin{align*}
      Ω \gramisa & \serr{array}  & \textrm{Débordement de tableau}
      \\ \gramor & \serr{ptr}    & \textrm{Erreur de pointeur}
      \\ \gramor & \serr{div}    & \textrm{Division par zéro}
      \\ \gramor & \serr{field}  & \textrm{Erreur de champ}
    \end{align*}
  }
