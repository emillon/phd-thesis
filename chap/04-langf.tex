...
\begin{itemize}
\item
  une fonction de lecture $\mathrm{get}_\mathcal{L} : R → A$
\item
  une fonction de mise à jour $\mathrm{put}_\mathcal{L} : (A × R) → R$
\end{itemize}
...
\begin{align*}
\tag{GetPut}
\mathrm{put}_\mathcal{L}(\mathrm{get}_\mathcal{L}(r), r) = & r \\
\tag{PutGet}
...
\begin{definition}[Composition de lentilles]
  ...
  Soient $\mathcal{L}_1 ∈ \setLens{A}{B}$ et $\mathcal{L}_2 ∈ \setLens{B}{C}$.

  La composition de $\mathcal{L}_1$ et $\mathcal{L}_2$ est la lentille
  $\mathcal{L} ∈ \setLens{A}{C}$ définie de la manière suivante:

  \begin{align*}
    \mathrm{get}_{\mathcal{L}} (r) =&
        \mathrm{get}_{\mathcal{L}_2}
        (\mathrm{get}_{\mathcal{L}_1} r) \\
    \mathrm{put}_{\mathcal{L}} (a, r) =&
        \mathrm{put}_{\mathcal{L}_1} (\mathrm{put}_{\mathcal{L}_2}
        (a, \mathrm{get}_{\mathcal{L}_1} r), r) \\
  \end{align*}

  On notera alors $\mathcal{L} = \mathcal{L}_1 \ggg \mathcal{L}_2$.

\end{definition}

\begin{proof}
On prouve que $\mathcal{L}_1 \ggg \mathcal{L}_2 ∈ \setLens{A}{C}$.
...
= & \{ \textrm{définition de } \lensGetX{L} \} \\
& \lensGet{L_2}
    {
      \lensGet{L_1}
        {
...
= & \{ \textrm{définition de } \lensPutX{L} \} \\
& \lensGet{L_2}
    {
      \lensGet{L_1}
        {
