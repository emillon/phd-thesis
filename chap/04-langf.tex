...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \draw [->] (m0) -- node[auto] {$e → \mathrm{fun}(\vec{a}) \{i\}$}   (m1);
...
\begin{itemize}
\item mettre à jour l'explication post-figure~\ref{fig:fcall-details}
\item mettre à jour la figure~\ref{fig:fcall-details}
