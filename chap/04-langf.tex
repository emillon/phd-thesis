...
et en
\texttt{(b)}.
Les règles d'évaluation sont donc les suivantes.
Dans le cas où la valeur référencée n'a pas la forme $m[φ']_Φ$, on renvoie
$\serr{var}$. Cela est préférable à renvoyer $\serr{ptr}$ car on montrera que la
