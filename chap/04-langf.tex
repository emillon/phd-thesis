...
indépendants: à chaque appel de fonction, un nouveau cadre de pile
...
suppose dans une étape précédente chaque accès à un champ de structure a été
décoré du type complet correspondant. Par exemple, il est possible de
...
quel type appartient quels champs et d'émettre ces étiquettes. C'est d'ailleurs
