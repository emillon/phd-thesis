...
\begin{figure}
  ...
  \gramlr{Left-values}{
    \begin{align*}
      ...
      \\  \gramor & lv.l_S & \textrm{Accès à un champ}
...
\begin{figure}%{{{
  ...
  \gramlr{Erreur}{
    \begin{align*}
      ...
      \\ \gramor & Ω_{field}  & \textrm{Erreur de champ}
    \end{align*}
  }
...
\begin{definition}[Accès par champ]
  ...
  \begin{align*}
    ...
    \{ l_1 : v_1; … ; l_n : v_n \}[l]_L = & Ω_{field} \mbox{ sinon} \\
    \{ l_1 : v_1; … ; l_n : v_n \}[l ← v]_L = & Ω_{field} \mbox{ sinon}
  \end{align*}
