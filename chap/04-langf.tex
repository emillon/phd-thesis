...
la variable, puis calculer une nouvelle valeur en remplaçant la sous-valeur la
mémoire, avant de replacer cette nouvelle valeur à sa place en mémoire. En
pratique, on définira deux lentilles: une qui relie un état mémoire à la valeur
d'une variable, et une qui relie une valeur à une de ses sous-valeurs. Avec
cette technique, on peut définir en une seule fois les opération de lecture et
d'écriture de sous-valeurs imbriquées.

% TODO schémas lentilles comme dans pres APR
...
% TODO couleur: est-ce possible d'avoir de la couleur qui passe en N&B?
...
% TODO un peu court, reviens sur les lentilles et les accesseurs

% TODO peut être rappeler le but...
