...
\begin{figure}%{{{
  ...
  \gramlr{Erreur}{
    \begin{align*}
      Ω \gramisa & Ω_{array}  & \textrm{Débordement de tableau}
...
\item
  des opérateurs de décalage à gauche ($«$) et à droite ($»$) sont présents.
...
% TODO que se passe-t'il dans les autres cas ? introduire un Ω_{typ} ?
...
\begin{itemize}
\item cas d'erreur pour le déref nul (quid des deref invalides?)
\item cas d'erreur pour le débordement de tableau
