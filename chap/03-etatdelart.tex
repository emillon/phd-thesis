...
% Il y a beaucoup de choses dans le TODO... ty penses toute les mettre ?
...
utilisateurs dont il est ici l'objet~\cite{cquk-usenix04}. Il est utile de
détailler pourquoi notre approche est différente de ces travaux. Tout d'abord,
CQual modifie fondamentalement l'ensemble du système de types (via le
jugement de typage) et insère des qualificateurs à tous les niveaux de types. Au
contraire, nous ne modifions le système de types que là où cela est nécessaire,
c'est-à-dire sur les types pointeurs.
...
% TODO [E] ce sont justes des langages d'annotations : qu'en fait-on après ?
