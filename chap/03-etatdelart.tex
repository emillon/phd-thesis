...
ensemble calculable (théorème de Rice). Autrement dit, il ne peut exister une
procédure de décision prenant un programme et le déclarant correct ou incorrect.
