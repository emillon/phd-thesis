...
utilisant une analyse de forme «pointe-sur»~\cite{oakland08}. Comme
...
nécessite une instrumentation dynamique qui se paye en performances.
...
variables locales, et les pointeurs lourds de Cyclone qui apportent une sûreté à
l'arithmétique de pointeurs, au prix d'un test dynamique.
