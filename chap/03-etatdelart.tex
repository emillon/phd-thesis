...
règles comme $"-" × "-" = "+"$ définissent le domaine abstrait des signes
(figure~\ref{fig:dom-sig}). En calculant les valeurs extremales d'une variable,
on obtient le domaine des intervalles.
