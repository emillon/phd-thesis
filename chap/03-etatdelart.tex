...
abstraite, le but de cette analyse est d'être très précis, au détriment d'un
temps de calcul important dans certains cas.

% TODO[S] bounded model checking = espace d'états infini mais sous espaces
% donnés explorés
% partition de l'espace d'états en classes d'équivalences à index fini
