...
% TODO[S] oui mais le processus de certif demande les CC pour la sécu
...
% TODO[S] attention contresens ce n'est pas une itération de Kleene
...
% TODO[E] il y a pls fois cette def et cet usage de "sound"

Cette technique est très puissante: si un interprète abstrait \emph{sound}
(c'est-à-dire ne manquant aucun programme incorrect) analyse un programme et ne
renvoie pas d'erreur, alors on a prouvé que le programme est correct (par
rapport aux propriétés que vérifient les domaines abstraits). Cela a été
appliqué avec succès avec les analyseurs
...
% TODO[S] ↑ ils ne sont pas basés que sur AI car AI garantit soundness
...
% TODO[E] quid du model checking? et de la preuve de programme
...
% TODO[E] considérable => c'est quoi par rapport à linéaire: exp?

% TODO virer car para C7 en parle
...
%TODO[E] tu cites leur nom mais pas Simonet et autres jury
...
%TODO[E] smart pointers => en dire un mot ou citer
...
% TODO[S] non applicables pour certif car instrumentation
...
% TODO[E] que veux tu dire par les systèmes d'aide à la preuve ?
...
% TODO[S] efficace à -> français
% TODO[S] expressivité -> ex
...
% TODO[S] je ne comprends pas ce qu'est cette solution safespeak
