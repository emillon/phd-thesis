...
``exploser'' en temps quadratique. % TODO check le coup du quadratique
...
l'absence d'erreur dans les programmes système. C'est pourquoi dans notre
solution, \langname, nous approchons la sûreté de la manière suivante:
