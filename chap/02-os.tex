...
impératifs. Mais pour faire quelque chose de visible cela ne suffit pas : il
faut parler au reste du matériel.
...
%TODO Mettre des vrais nombres plutôt que du symbolique
...
\section{Tâches, niveaux de privilèges}
\label{sec:taches}
...
% TODO expliquer la fig

%TODO Redite qui n'apporte pas plus d'explication

%TODO ici un morceau déplacé dans le chap etude de cas
