...
Puisque $Γ ⊢ x : t$, on peut appliquer le lemme~\ref{lemma:var-typ}.
...
% TODO vérifier la cohérence depuis le changement d'ordre
...
% TODO check avec le nouveau M-Pop
...
Le lemme~\ref{lemma:mem-typ} adapté aux extensions noyau % TODO
permet de conclure quant à la compatibilité mémoire.
% }}}
