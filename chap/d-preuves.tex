...
On procède par induction sur la dérivation de $\mm{m}{e}{m'}{e'}$.

\paragraph{\textsc{Ctx}:} % {{{ TODO
\[ \semrule{Ctx} \]
% }}}
\paragraph{\textsc{Ctx-Lv}:} % {{{ TODO
\[ \semrule{Ctx-Lv} \]
% }}}
\paragraph{\textsc{Ctx-Instr}:} % {{{ TODO
\[ \semrule{Ctx-Instr} \]
% }}}
\paragraph{\textsc{Exp-Err}:} % {{{ TODO
\[ \semrule{Exp-Err} \]
% }}}
\paragraph{\textsc{Eval-Err}:} % {{{ TODO
\[ \semrule{Eval-Err} \]
% }}}
