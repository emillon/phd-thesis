...
% TODO refaire avec la nouvelle sem
...
% }}}
\paragraph{\textsc{Exp-Call-Return}:} % {{{ TODO
\[ \semrule{Exp-Call-Return} \]
% }}}
\paragraph{\textsc{Exp-Call-Return-Unit}:} % {{{ TODO
...
Donc par inversion
(seule la règle \textsc{S-Ref} permet de dériver un tel jugement), on a
