...
on décrit le cas de deux \emph{bugs} dans le noyau Linux. Le premier porte sur
un pilote de carte graphique Radeon et le second sur l'appel système
\texttt{ptrace} sur l'architecture Blackfin. Ils manipulent de manière non
sécurisée des pointeurs provenant de l'espace utilisateur. On montre que, pour
