...
\item L'ensemble des fonctions du programme est trié topologiquement selon la
  relation $\prec$ définie par $f \prec g \eqdef \textrm{``} g \textrm{ apparaît
  dans la définition de } f \textrm{''}$. Cela est fait en construisant une
  représentation de $\prec$ sous forme de graphe, puis en faisant un parcours en
  largeur de celui-ci.
