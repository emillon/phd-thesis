...
\begin{itemize}
    \item
  \texttt{/*!npk f : (Int) -> Int */} signifie que \texttt{f} est une
  fonction prenant comme argument un entier et renvoyant un entier.

  \item
      \texttt{/*!npk userptr x*/} signifie que \texttt{x} a pour type $\ptrU{a}$,
      où $a$ est une inconnue de type.

  \item
      \texttt{/*!npk userptr_fieldp p f*/} signifie que \texttt{x} a pour type
      $\{ f: \ptrU{a} ; … \}~*$, où $a$ est une inconnue de type.
\end{itemize}
