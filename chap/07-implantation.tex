...
\begin{itemize}
  ...
  \item \textbf{Expressif} : la plupart des primitives présentes dans les
    ...
    \footnote{
      Penjili étant spécialisé dans les logiciels embarqués aéronautiques, les
constructions complexes comme \texttt{longjmp} / \texttt{setjmp} ou les
exceptions ne sont pas nécessaires.
    }
