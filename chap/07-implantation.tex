...
% TODO[E] quelque part, c'est une restriction?
% Pas clair (pour moi)
% Die d'où à où !
...
La fonction appellée par le reste du code, appellée \texttt{unify}, peut
...
% TODO[PJ] pourquoi impérative ? c'est plus facile à prouver en fonctionnel

% TODO choisir si on présente l'algo en fonctionnel ou imp
...
traitement est plus long que celui d'un compilateur comme GCC ou \texttt{clang},
mais reste de l'ordre de quelques secondes. \ctonewspeak a été utilisé pour
compiler des projets de l'ordre du million de lignes de code source prétraité,
et son exécution ne prenait pas plus de quelques minutes.
