...
de types. Ce prototype est distribué sur~\link{penjili} sous le nom de
\ptrtype. Il est constitué d'environ 1600 lignes d'OCaml.

% TODO[E] 1600 lignes, Damas : déjà dit
