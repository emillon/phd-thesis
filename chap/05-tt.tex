...
\begin{figure}
  ...
  \begin{mathpar}
    \irule{S-Int}{ }{\semtyp{m}{n}{\tInt}}

    \irule{S-Float}{ }{\semtyp{m}{d}{\tFloat}}

    \irule{S-Unit}{ }{\semtyp{m}{\eUnit}{\tUnit}}

    \irule{S-Null}{ }{\semtyp{m}{\eNull}{τ~*}}

    \irule{S-Ref} { \semtyp{m}{m[φ]_Φ}{τ}} {\semtyp{m}{\widehat{\&}~φ}{τ~*}}
    ...
    \irule{S-Fun}{ } {\semtyp{m}{\eFun{x_1, …, x_n}{i}}{\stFun{n}}}
  \end{mathpar}
...
\item
  ...
  \begin{itemize}
    ...
    \item si $Γ ⊢ \eNull : t$, alors $∃ t', t = t'*$ % TODO typographie le
textsc passe pas
