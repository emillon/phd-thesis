...
% TODO un mot sur les structures et pourquoi S est toplevel

% TODO mettre ces choses là à leur place

% TODO mettre les règles des suites de phrases à la fin
...
% TODO donner une référence : Pascal?
...
% TODO rq sur le comp-ground ou t et τ se confondent
...
% TODO?? 1er fois que cela apparait
...
% TODO on peut aussi changer des bindings si ça n'influe pas sur $e$
\end{lemma}
...
% TODO modifier progrès pour ajouter la clause cleanup
...
% TODO la compat est à faire sur m'
