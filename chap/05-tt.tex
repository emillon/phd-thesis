...
programme. Supposons que $\typh{Γ}{p}{Γ'}$ et $\mcomp{Γ}{m}$. Alors un des deux
cas suivants est possibles:

\begin{itemize}
\item $∃ m'. \ph{m}{p}{m'}$
\item $∃ Ω ∈ \{\serr{div},\serr{array},\serr{ptr}\}, \ph{m}{p}{Ω}$
\end{itemize}

% TODO il faut définir ph Ω
