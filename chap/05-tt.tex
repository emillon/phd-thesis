...
\begin{itemize}
\item
  définition5.1 Pour moi il s'agit plutôt d'une notation. Une définition
  serait plutôt quelque chose d'inductif sur la forme de l'expression
\item
  définition 5.4 $\Gamma\_f$ dans le texte n'apparaît pas dans la formule
\item
