...
\cDom{Γ} &\eqdef \{ g_i / i ∈ [1;n] \} ∪ \{ l_i / i ∈ [1;m] \}\\
...
Commençons par donner un résultat préliminaires. On utilise les notations
suivantes:
...
Partant de $\mcomp{Γ}{\cCleanup{\cPop{m'}} }$ et $Γ ⊢ φ : t$, on déduit que
$\cVar{Φ}$ est soit une globale soit une locale de hauteur
$|\cCleanup{\cPop{m'}}| = |m'| - 1 = |m|$.
