...
$e$ est alors égal à \eUnit, qui est une valeur.
%}}}
...
\paragraph{\textsc{Lv-Deref} :}%{{{
  ...
  \[
  \left( \disprule{Lv-Deref} \right)
  \]

  Appliquons l'hypothèse de récurrence à $e' = lv$.
...
% TODO virer le 2è cas Lv-Deref au dessus
% }}}
...
\begin{itemize}
\item inverser les lemme et le théorème de progrès
