...
, if the semantic types of visible variable coincide with
their static types
\footnote{
...
\item généraliser la fbox de la fig~\ref{fig:regles-typ-sem}
      (p~\pageref{fig:regles-typ-sem})
\end{itemize}
...
and user memory references are ``untainted'' to
