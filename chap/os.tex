...
\caption[Cadres de pile]{
  ...
  Au début de la fonction, les instructions \texttt{push \%ebp} et \texttt{mov
  \%esp, \%ebp} sauvegardent l'ancienne valeur de \ebp et pointer \ebp à une
  endroit fixe dans le cadre de pile.
