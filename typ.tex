...
% TODO les quotes font un poil lame

%\begin{shadequote}[r]{Pete Fenelon}
...
%\begin{shadequote}[r]{Henry Spencer}
%Those who don't understand UNIX are condemned to reinvent it, poorly.
%\end{shadequote}

%\begin{shadequote}[r]{Charles Babbage, Passages from the Life of a Philosopher}
