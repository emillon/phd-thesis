...
\paragraph{LLVM}\cite{llvm} est un backend de compilateur développé par Apple.
Il se présente comme un concurrent direct de GCC et permet de compiler
\href{http://lwn.net/Articles/411654/}{le noyau Linux} et la majeure
partie de
