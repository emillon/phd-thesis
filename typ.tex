...
arête "condition" qui s'évalue à une valeur "vrai", soit en appliquand les
effets de bord d'une arête "instruction".

Dans la suite, on suppose qu'on a à notre disposition les jugements suivants :

\begin{itemize}
\item $\langle l, instr, l' \rangle$ :
  on peut passer du point $l$ au point $l'$ en effectuant l'instruction $instr$.

\item $\langle l, cond, l' \rangle$ :
  on peut passer du point $l$ au point $l'$ si $cond$ s'évalue en une valeur entière
  non nulle (comme en C).
\end{itemize}
