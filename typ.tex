...
compilation de C prétraité vers Newspeak, puis compilation de Newspeak vers ce
langage.
...
\node [below of=c3, minimum height=3cm, node distance=2.2cm] (c4){};
...
\node [below of=cc3, minimum height=3cm, node distance=2.2cm](cc4){};

\draw[->] (c1) -- node[above] {{\tiny \tt gcc -E}} (cc1);
\draw[->] (c2) -- (cc2);
...
\node [below of=no3, minimum height=3cm, node distance=2.2cm](no4){};

\draw[->] (cc1) -- node[above] {{\tiny \tt c2newspeak -c}} (no1);
\draw[->] (cc2) --  (no2);

\draw[->] ($ (c3b.north east)!0.5!(c3s.south east) + (3mm,0) $) -- node[above] {\tiny \tt ada2newspeak -c} (no3);


\node [file, right of=no2] (npk) {\textcolor{black}{.npk}};

\node [right of=no3, minimum height=3cm, node distance=2.2cm](npk2){};
\node [right of=no4, minimum height=3cm, node distance=2.2cm](npk3){};

\node[draw, ellipse, right of=no2, minimum height=3cm]{};

\draw[->] (no1) -- node {} (npk);
\draw[->] (no2) -- node[above] {{\tiny \tt c2newspeak}} (npk);
\draw[->] (no3) -- node {} (npk);
...
\draw[->] (npk) -- node[above] {{\tiny \tt penjili}} (warn);
