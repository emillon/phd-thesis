...
\def\semrule#1{
  \switch{#1}
    ...
    {Ctx-Lv}{ \irule{Ctx-Lv}
             { \mmlv{m}{lv}{m'}{lv'} }
             { \mmlv{m}{\ctxSub{C_L}{lv}}{m'}{\ctxSub{C_L}{lv'}} }
    }
    {Ctx-Instr}{ \irule{Ctx-Instr}
             { \mmlv{m}{i}{m'}{i'} }
             { \mmlv{m}{\ctxSub{C_I}{i}}{m'}{\ctxSub{C_I}{i'}} }
    }
...
\def\figctx{
  ...
  C \gramisa & \ctxEmpty
  \\ \gramor & C_L
  \\ \gramor & \ctxOp{C}{e} & \gramor & \ctxOp{v}{C}
  \\ \gramor & \ctxUnOp{C}
  \\ \gramor & \ctxSet{C}{e} & \gramor & \ctxSet{φ}{C}
  \\ \gramor & \{ f_1:v_1 ; … ; f_i:C ; … ; f_n:e_n \}
  \\ \gramor & [ v_1 ; … ; C ; … ; e_n ]
  \\ \gramor & C (e_1, …, e_n) & \gramor & f (v_1, …, C, …, e_n)
  \\
  \\
  C_L \gramisa & \ctxLvDeref{C_L}
  \\   \gramor & \ctxLvField{C_L}{f}
  \\   \gramor & \ctxLvIndex{C_L}{e} & \gramor & \ctxLvIndex{φ}{C}
  \\
  \\
  C_I \gramisa & C_i;i
