...
\begin{tikzpicture}
  \begin{scope}
    \node (A) {\includegraphics[width=0.98\textwidth]{curies.pdf}};
...
{\large %Soutenue le \thedate{} devant le jury composé de \\% TODx

\def\juryh##1{\multicolumn{2}{c}{\textbf{##1}}}

% TODx titres
\begin{tabular}{rl}
\juryh{Rapporteurs} \\
Sandrine Blazy & IRISA \\
Pierre Jouvelot & Mines ParisTech \\ % TODO MINES
\juryh{Directeurs} \\
Emmanuel Chailloux & Université Pierre et Marie Curie \\
Sarah Zennou & EADS Innovation Works \\
%\juryh{Examinateurs} \\ TODx
