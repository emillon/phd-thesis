...
% TODO [E] en quoi le fait d'être compilé change des choses ?
...
% TODO en Ada les access type sont liés à un pool en particulier
% TODO cf. Rust
...
%1.1
%- on ne comprend pas "entre ces niveaux d'abstraction" Remplacer par "entre tous ces aspects" ?
%- dernier parag, manque en devant particulier
%- dernier parag, dans [Tan07] => pas français

%1.2
    %- supprimer sont dans la phrase les accès sont possibles
    %- tu pourrais ajouter un ex d'appel système en C pour expliquer le pb du déréférencement

%1.3
   %- je ne comprends pas pourquoi tu parles du typage du langage machine alors que tu vas typer du C
   %- typage statique. Phrases 2 et 3 compliquent l'explication je trouve
...
%partout dans la thèse : remplacer c'est à dire par c'est-à-dire

%1.5

  %- manque sur dans "nous nous appuierons"
  %- typo pettra au lieu de permettra
%- il faudrait pour chaque front-end dire pourquoi ça n'est pas la solution retenue

%1.6
 %- je ne comprends pas ce qu'est la "sémantique dynamique"
 %- reprendre le français de la phrase "afin que la manière"
 %- reprendre le français de la phrase "consistant d'un bug"

%Pourquoi ne pas présenter informellement le cas d'étude dans l'intro
%pour montrer que de vrais bugs existent ?

%Chapitre 9
%- manque s à limitation (chapeau de chapitre)
%- tu sabotes ton travail en commençant par les limitations. Présente d'abord un résumé de tes travaux puis dans une section "travaux futurs" tu discutes des améliorations à apporter liées aux limitations actuelles de SAFESPEAK
%- typo remplacer où par ou dans "où même idiomatiques" (+ retirer s à même)
%- parag Allocation dynamique. Revoir la phrases "Ces fonctions manipulent..."
%- 9.2 manque s à "être également exprimée de cette manière"
%- est-ce que tu as réfléchi à d'autres classes de propriété de sécurité pour lesquelles ton système de type pourrait répondre ?
