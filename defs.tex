...
\vcenter{\hbox{
\begin{tikzpicture}[scale=0.7]
  \draw[fill=#1] (-1.25,-1.25) rectangle ++ (2.5,2.5);
  \node[fill=#2, draw, star, minimum size=6mm] at (-0.6, 0.6) {};
  \node[fill=#3, draw, star, minimum size=6mm] at ( 0.6, 0.6) {};
  \node[fill=#4, draw, circle, minimum size=6mm] at (-0.6,-0.6) {};
  \node[fill=#5, draw, regular polygon, regular polygon sides=5, minimum size=6mm] at ( 0.6,-0.6) {};
  \node at (-2,  0.6) {a};
  \node at ( 2,  0.6) {b};
  \node at (-2, -0.6) {c};
  \node at ( 2, -0.6) {d};
