...
\begin{frame}\frametitle{Lentilles en sémantique}
...
\begin{frame}\frametitle{Exemple : par variable ($V$)}
...
\begin{frame}\frametitle{Exemple : par chemin ($Φ$)}
...
\begin{frame} \insertcode{tc-c.c} \end{frame}
\begin{frame} \insertcode{tc-ml.c} \end{frame}
\begin{frame} \insertcode{tc-ty.c} \end{frame}
