...
% TODO remplacer par une "BD" bonhommes rouges & vert
...
\begin{frame}{Problème des pointeurs dans les appels système}
    ...
    %TODO gros pb sur ce slide
    % 2 carac: qui controle
    % sur quoi ça pointe

    % 2 types de copie
    % avec check, sns check

    % TODO figure avec cas interdits
    % TODO ne pas mentionner statique/dynamique
\begin{itemize}
